...
def load_all_assets():
    ...
    # arrow keys
    load_image("sprites/pressed_arrow_up.png", "spr_pressed_arrow_up", False, True, 128)
    load_image("sprites/pressed_arrow_up_right.png", "spr_pressed_arrow_up_right", False, True, 128)
    load_image("sprites/pressed_arrow_right.png", "spr_pressed_arrow_right", False, True, 128)
    load_image("sprites/pressed_arrow_down_right.png", "spr_pressed_arrow_down_right", False, True, 128)
    load_image("sprites/pressed_arrow_down.png", "spr_pressed_arrow_down", False, True, 128)
    load_image("sprites/pressed_arrow_down_left.png", "spr_pressed_arrow_down_left", False, True, 128)
    load_image("sprites/pressed_arrow_left.png", "spr_pressed_arrow_left", False, True, 128)
    load_image("sprites/pressed_arrow_up_left.png", "spr_pressed_arrow_up_left", False, True, 128)
    load_image("sprites/unpressed_arrow_up.png", "spr_unpressed_arrow_up", False, True, 64)
    load_image("sprites/unpressed_arrow_up_right.png", "spr_unpressed_arrow_up_right", False, True, 64)
    load_image("sprites/unpressed_arrow_right.png", "spr_unpressed_arrow_right", False, True, 64)
    load_image("sprites/unpressed_arrow_down_right.png", "spr_unpressed_arrow_down_right", False, True, 64)
    load_image("sprites/unpressed_arrow_down.png", "spr_unpressed_arrow_down", False, True, 64)
    load_image("sprites/unpressed_arrow_down_left.png", "spr_unpressed_arrow_down_left", False, True, 64)
    load_image("sprites/unpressed_arrow_left.png", "spr_unpressed_arrow_left", False, True, 64)
    load_image("sprites/unpressed_arrow_up_left.png", "spr_unpressed_arrow_up_left", False, True, 64)
    load_image("sprites/neutral_zone.png", "spr_neutral_zone", False, True, 64)
